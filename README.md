...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,279 | 🐛 93 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 48,741 | 🐛 6 | 📅 2026-08-10.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 25,297 | 🐛 334 | 🌐 Java | 📅 2026-08-12
...
* [TapTargetView](https://github.com/KeepSafe/TapTargetView) ⭐ 5,465 | 🐛 57 | 🌐 Java | 📅 2024-10-08 - An implementation of tap targets from the Material Design guidelines for feature discovery.
...
* [Spotlight](https://github.com/TakuSemba/Spotlight) ⭐ 3,666 | 🐛 31 | 🌐 Kotlin | 📅 2022-12-03 - Android Library that lights items for tutorials or walk-throughs etc...
...
* [Picasso](https://github.com/square/picasso) ⭐ 18,812 | 🐛 212 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,155 | 🐛 260 | 🌐 Kotlin | 📅 2026-08-14 - An Android library for managing images and the memory they use.
...
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,880 | 🐛 69 | 🌐 Kotlin | 📅 2026-08-14 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,194 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
...
* [Gson](https://github.com/google/gson) ⭐ 24,233 | 🐛 343 | 🌐 Java | 📅 2026-08-14 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,154 | 🐛 112 | 🌐 Kotlin | 📅 2026-08-11 - A modern JSON library for Android and Java.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 47,044 | 🐛 132 | 🌐 Kotlin | 📅 2026-08-14 - An HTTP+SPDY client for Android and Java applications.
...
* [logger](https://github.com/orhanobut/logger) ⭐ 13,843 | 🐛 81 | 🌐 Java | 📅 2022-09-14 - Simple, pretty and powerful logger for android
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,844 | 🐛 62 | 🌐 Kotlin | 📅 2026-08-07 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,415 | 🐛 52 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [Pidcat](https://github.com/JakeWharton/pidcat) ⭐ 4,947 | 🐛 67 | 🌐 Python | 📅 2024-05-10 - a colored command-line ADB wrapper that only shows log entries for a specific application package
...
* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,161 | 🐛 31 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,886 | 🐛 750 | 🌐 Java | 📅 2026-08-14 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,207 | 🐛 10 | 🌐 Java | 📅 2026-08-11- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 34,066 | 🐛 0 | 🌐 Java | 📅 2026-07-28 - Integration with Barcode Scanner via Intent.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,404 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-14 - Automatically generates an About this app section, with a list of used libraries.
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,785 | 🐛 223 | 🌐 Kotlin | 📅 2026-08-12 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 126,347 | 🐛 1,053 | 🌐 C++ | 📅 2026-08-14 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,312 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-14 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
