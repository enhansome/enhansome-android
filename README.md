...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,273 | 🐛 92 | 📅 2025-10-27
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,705 | 🐛 367 | 🌐 Java | 📅 2026-08-12 - A fast dependency injector for Android and Java.
...
* [AndroidFillableLoaders](https://github.com/JorgeCastilloPrz/AndroidFillableLoaders) ⭐ 1,972 | 🐛 15 | 🌐 Java | 📅 2022-07-20 - Fillable progress view working with SVG paths. Nice option too for creating interesting app logos.
...
* [DragListView](https://github.com/woxblom/DragListView) ⭐ 710 | 🐛 0 | 🌐 Java | 📅 2025-05-08 - Drag and drop to reorder items in a list, grid or board.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,022 | 🐛 660 | 🌐 Java | 📅 2026-08-12 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
...
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,155 | 🐛 261 | 🌐 Kotlin | 📅 2026-08-12 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 16,837 | 🐛 460 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,876 | 🐛 70 | 🌐 Kotlin | 📅 2026-08-12 - Image loading for Android backed by Kotlin Coroutines.
...
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,929 | 🐛 627 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,842 | 🐛 62 | 🌐 Kotlin | 📅 2026-08-07 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [Nitrite Database](https://github.com/dizitart/nitrite-database) ⭐ 911 | 🐛 3 | 🌐 Java | 📅 2026-08-10 - A NoSQL embedded document store for Android with MongoDb like API.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,411 | 🐛 51 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,384 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Siren](https://github.com/eggheadgames/Siren) ⭐ 136 | 🐛 13 | 🌐 Java | 📅 2020-12-14 - focused feature set that mimicks the popular iOS library of the same name. Supports Play and Amazon.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,912 | 🐛 750 | 🌐 Java | 📅 2026-08-12 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,210 | 🐛 10 | 🌐 Java | 📅 2026-08-11- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 34,067 | 🐛 0 | 🌐 Java | 📅 2026-07-28 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 19,950 | 🐛 1 | 🌐 Java | 📅 2026-08-05 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,403 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-11 - Automatically generates an About this app section, with a list of used libraries.
...
* [Sensey](https://github.com/nisrulz/sensey) ⭐ 2,657 | 🐛 24 | 🌐 Kotlin | 📅 2026-06-08 - Detecting gestures in a snap.
...
* [Licensee](https://github.com/cashapp/licensee) ⭐ 751 | 🐛 35 | 🌐 Kotlin | 📅 2026-08-12 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
