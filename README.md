...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,277 | 🐛 93 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 48,738 | 🐛 6 | 📅 2026-08-10.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 25,296 | 🐛 334 | 🌐 Java | 📅 2026-08-12
...
* [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu) ⭐ 10,994 | 🐛 306 | 🌐 Java | 📅 2021-09-19 - Library to create applications with slide-in menus.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,024 | 🐛 660 | 🌐 Java | 📅 2026-08-14 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
...
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,155 | 🐛 260 | 🌐 Kotlin | 📅 2026-08-13 - An Android library for managing images and the memory they use.
...
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,879 | 🐛 70 | 🌐 Kotlin | 📅 2026-08-13 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,197 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
...
* [Gson](https://github.com/google/gson) ⭐ 24,233 | 🐛 343 | 🌐 Java | 📅 2026-08-11 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 47,045 | 🐛 134 | 🌐 Kotlin | 📅 2026-08-14 - An HTTP+SPDY client for Android and Java applications.
...
* [logger](https://github.com/orhanobut/logger) ⭐ 13,844 | 🐛 81 | 🌐 Java | 📅 2022-09-14 - Simple, pretty and powerful logger for android
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,843 | 🐛 62 | 🌐 Kotlin | 📅 2026-08-07 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [Logback Android](https://github.com/tony19/logback-android) ⭐ 1,264 | 🐛 12 | 🌐 Java | 📅 2026-08-10 - Logback port to Android which provides a highly configurable logging framework for Android apps.
...
* [DbInspector](https://github.com/infinum/android_dbinspector) ⭐ 953 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-01 - Provides a simple way to view the contents of the in-app database for debugging purposes.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,970 | 🐛 128 | 🌐 Kotlin | 📅 2026-08-11 - Catch memory leaks as they occur.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,414 | 🐛 52 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
* [Android Debug Database](https://github.com/amitshekhariitbhu/Android-Debug-Database) ⭐ 8,675 | 🐛 83 | 🌐 Java | 📅 2026-02-05 - Android Debug Database is a powerful library for debugging databases and shared preferences in Android applications.
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,385 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,164 | 🐛 31 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,919 | 🐛 751 | 🌐 Java | 📅 2026-08-12 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,211 | 🐛 10 | 🌐 Java | 📅 2026-08-11- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 34,071 | 🐛 0 | 🌐 Java | 📅 2026-07-28 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 19,949 | 🐛 1 | 🌐 Java | 📅 2026-08-05 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,403 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-11 - Automatically generates an About this app section, with a list of used libraries.
* [Android Priority Job Queue](https://github.com/yigit/android-priority-jobqueue) ⭐ 3,378 | 🐛 140 | 🌐 Java | 📅 2022-10-22 - Implementation of a Job Queue to easily schedule jobs (tasks) that run in the background, improving UX and application stability.
...
* [Licensee](https://github.com/cashapp/licensee) ⭐ 752 | 🐛 35 | 🌐 Kotlin | 📅 2026-08-12 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [React Native](https://github.com/facebook/react-native) ⭐ 126,344 | 🐛 1,051 | 🌐 C++ | 📅 2026-08-14 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,305 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-13 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
